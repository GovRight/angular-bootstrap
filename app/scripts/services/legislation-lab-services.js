...
(function() {
  angular
    .module('LLServices', ['govrightCorpusServices', 'ui.router']);
}());
...
/**
 * @ngdoc object
 * @name LLServices.LLMessage
 * @header LLServices.LLMessage
 * @object
 *
 * @description
 *
...
(function () {
  ...
  function Message($mdToast, $mdDialog, $state) {
    return {
      ...
      /**
       * @ngdoc method
       * @name LLServices.LLMessage#error404
       * @methodOf LLServices.LLMessage
       *
       * @description
       *
      ...
      /**
       * @ngdoc method
       * @name LLServices.LLMessage#transition
       * @methodOf LLServices.LLMessage
       *
       * @description
       *
      ...
      /**
       * @ngdoc method
       * @name LLServices.LLMessage#success
       * @methodOf LLServices.LLMessage
       *
       * @description
       *
      ...
      /**
       * @ngdoc method
       * @name LLServices.LLMessage#error
       * @methodOf LLServices.LLMessage
       *
       * @description
       *
      ...
      /**
       * @ngdoc method
       * @name LLServices.LLMessage#confirm
       * @methodOf LLServices.LLMessage
       *
       * @description
       *
